...
class _AIChatScreenState extends State<AIChatScreen>
  ...
  Future<void> _sendMessage() async {
    ...
    // إضافة الرسالة إلى القائمة محلياً لتحديث الواجهة وسجل المحادثة
    final userMessage = {
      'role': 'user',
    ...
    try {
      // إرسال سجل المحادثة كاملاً مع الصورة المختارة للخدمة
      final response = await _aiService.getChatResponseWithHistory(
        messages: _messages,
